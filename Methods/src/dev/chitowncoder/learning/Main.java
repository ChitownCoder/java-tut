...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        displayHighScorePosition("Colton", highScorePosition);

        highScorePosition = calculateHighScorePosition(50);
        displayHighScorePosition("Logan", highScorePosition);

        highScorePosition = calculateHighScorePosition(1000);
        displayHighScorePosition("Dominick", highScorePosition);
        ...
        displayHighScorePosition("Todd", highScorePosition);
    }
